...
export default function ReportPage() {
  ...
  if (!match.stats) return <p>Report unavailable.</p>;
    ...
    <>
      ...
      <main className="min-h-screen pt-20 pb-16 px-4">
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <p className="p-4 text-amber-300">LEGACY / UNVERIFIED: This report may contain simulated statistics. It is not a verified match analysis.</p>
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-0">
              ...
              <div className="px-8 py-5 border-b border-white/10">
                ...
                <p className="text-white/80 text-sm leading-relaxed italic">&ldquo;{stats.narrative}&rdquo;</p>
              </div>
              ...
              <div className="px-8 py-4 flex items-center justify-between">
                ...
                <span className="text-white/20 text-xs italic">&ldquo;Unveil the Geometry of Your Game&rdquo;</span>
              </div>
